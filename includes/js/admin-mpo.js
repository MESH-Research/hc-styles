jQuery(function($){
    ...
    success:function(data) {
	   $("label[for='blog-public']").html('Public and allow search engines to index this site. <br>Note: it is up to search engines to honor your request. The site will appear in public listings around Humanities Commons.');
